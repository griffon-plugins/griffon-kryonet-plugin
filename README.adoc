= griffon-kryonet-plugin
:linkattrs:
:project-owner:   griffon
:project-repo:    griffon-plugins
:project-name:    griffon-kryonet-plugin
...
The Kryonet plugin adds a remoting client that uses the link:https://github.com/EsotericSoftware/kryonet[Kryonet, window="_blank"]
